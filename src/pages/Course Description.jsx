...
function CourseDescription() {
  return (
    <div>
      ...
      <Instructor />
      <CourseContent />
      <div className="group container relative mx-auto flex h-[250px] w-[250px] cursor-pointer items-center justify-center gap-3 border border-secondary rounded-lg sm:h-[317px] sm:w-[317px]">
