    ...
    <>
      <div className="bg-slate-300">
        <div className="navbar mx-auto w-11/12 ">
          ...
          <div className="navbar-end flex items-center space-x-3 hidden lg:flex">
            {/* Item 1 */}
            <div className="h-5 w-5 scale-x-110 transform text-2xl text-primary">
              {/* Your content for Item 1 */}
              <GoQuestion />
            </div>

            {/* Item 2 */}
            <button class="btn btn-circle btn-ghost mt-1 text-2xl text-primary">
              <div class="indicator">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5"
            ...
            <div className="dropdown dropdown-end scale-x-110 transform">            
              ...
              >
                <div className="w-10 rounded-full visible">
                  <img
